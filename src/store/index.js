...
export default new Vuex.Store({
  plugins: [
    createPersistedState({
      ...
      reducer({ tokenObj, myChannels, histories, nickname }) {
        return { tokenObj, myChannels, histories, nickname }
      }
    })
  ],
  state: {
  ...
  mutations: {
    ...
    // SET_SEX(state, gender) {
    //   console.log(gender)
    //   // console.log(666)
    //   state.index = gender
    //   if (gender === 1) state.gender = '女'
    //   if (gender === 0) state.gender = '男'
    // },
